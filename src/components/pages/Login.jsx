...
const Login = () => {
    return (
        /* Reduced vertical padding and adjusted height to ensure it fits the viewport */
        <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-white px-4 py-4">
            <div className="relative group w-full max-w-md">
                ...
                {/* Main Card: Tightened padding (py-6 instead of p-8) */}
